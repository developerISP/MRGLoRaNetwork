...
class CurrentOzonData extends StatefulWidget {
  ...
  ///3. the date of that value
  ///4. the two button to move around the chart
  CurrentOzonData(String unit, List<Data> data,  Color color, double width, double height, int index, {Function selectData}){
    this._unit = unit;
    this._data = data;
    this._color = color;
    this._width = width;
              ...
              child:  TweenAnimationBuilder(
                ...
                builder: (_, _value, __) {
                  ...
                  return Container(//_indicator
                    child: CustomPaint(
                      painter: OzonIndicator(_value, 100, widget._color),
                      ...
                      child: Container(
                        ...
                        child: Center(//_inner part of the indicator 
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(
                                (this.widget._index == widget._data.length-1 ? "today's" : widget._data[widget._index].date) + " value",
